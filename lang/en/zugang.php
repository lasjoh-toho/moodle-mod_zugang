...
$string['headingwlan'] = 'WLAN access';
$string['headingdock'] = 'Dock access';
$string['zipfile'] = 'Zip file (optional)';
$string['zipfile_help'] = 'An optional zip file offered as a download on the activity page (e.g. drivers, configuration profiles). Only shown if a file has been uploaded.';
$string['downloadzip'] = 'Download file: {$a}';
