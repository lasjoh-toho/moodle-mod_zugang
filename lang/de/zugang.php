...
$string['headingwlan'] = 'Zugangsdaten WLAN';
$string['headingdock'] = 'Zugangsdaten Dock';
$string['zipfile'] = 'ZIP-Datei (optional)';
$string['zipfile_help'] = 'Optionale ZIP-Datei, die auf der Aktivitätsseite als Download angeboten wird (z. B. Treiber, Konfigurationsprofile). Wird nur angezeigt, wenn eine Datei hochgeladen wurde.';
$string['downloadzip'] = 'Datei herunterladen: {$a}';
